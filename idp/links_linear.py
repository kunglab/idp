...
from .functions_linear import linear
...
class IncompleteLinear(link.Link):
    ...
    def __init__(self, in_size, out_size=None, nobias=False,
        ...
        super(IncompleteLinear, self).__init__()
    ...
    def __call__(self, x, coeffs=None, bcoeffs=None, ocoeffs=None):
        ...
        return linear(x, coeffs, self.W, self.b, bcoeffs=bcoeffs, ocoeffs=ocoeffs)
